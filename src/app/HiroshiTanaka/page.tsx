        ...
        <div className="absolute flex justify-center items-center inset-0 z-10 w-[71rem] 3xl:w-[45rem] 4xl:w-[57rem] bg-cover bg-center">
          <div className="relative leading-none 3xl:left-[12rem] 4xl:left-[11rem] left-[17rem] top-[-3rem] w-[100%] inset-0 flex justify-center  items-center gap-16 3xl:gap-8 4xl:gap-8 ">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                <button
                  className="text-white py-[10px] font-bold text-[24px] 3xl:text-[16px] 4xl:text-[20px] flex w-[15rem] 3xl:w-[12rem] 4xl:w-[16rem] p-2 justify-center items-center rounded-3xl bg-gradient-to-b whitespace-nowrap from-[#BAA716] to-[#B50D34]"
                  style={{ fontFamily: "Sansation" }}
                >
                  Plant Manager
                </button>
            ...
            <div className="">
              <p
                ...
                style={{ fontFamily: "Sansation" }}
              >
                40 years old, based in Tokyo, Japan.
              </p>
              <br />
              <br />
              <p
                ...
                style={{ fontFamily: "Sansation" }}
              >
                Plant Manager at a major manufacturing company with a degree in
                Mechanical Engineering and an MBA. Over 18 years of experience
          ...
          <div className="absolute 3xl:left-[138rem] 4xl:left-[130rem]  flex justify-center items-center inset-0 z-20 left-[153rem] 3xl:gap-10 w-[80rem]  3xl:w-[21rem]">
            <div className="w-[35rem] 3xl:w-[25rem] 4xl:w-[27rem] relative top-[-3rem] 3xl:top-[-2rem]">
              <div className="flex flex-col items-center leading-none gap-12  w-[44rem]  3xl:w-[30rem] 4xl:w-[40rem]">
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Sansation" }}
                  >
                    Enhance production efficiency, implement lean manufacturing
                    practices, and develop leadership skills among mid-level
                    managers.
                  </p>
                </div>
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "Sansation" }}
                  >
                    Addressing employee morale and retention, managing
                    cross-cultural teams, developing a pipeline of future
                    leaders.
                  </p>
                </div>
              </div>
            ...
            <div className="relative left-[84rem]  3xl:left-[49rem] 4xl:left-[73rem] bottom-[8rem] 3xl:bottom-[5rem] flex flex-col gap-[4rem] 3xl:gap-[3rem] 4xl:gap-[3rem]">
              ...
              <div className="flex w-[95rem] 3xl:left-[54rem] 4xl:left-[77rem] gap-48  3xl:gap-[4.5rem] 4xl:gap-[6rem]">
                <div className="">
                  <Image
                    src="/assets/CrossCultural.png"
                    alt="Cross Cultural"
                    width={450}
                    height={450}
                    className="fixed 3xl:w-[310px] 4xl:w-[400px]"
                ...
                <div className="">
                  <Image
                    src="/assets/LeadershipDevelopment.png"
                ...
                <div className="">
                  <Image
                    src="/assets/EmployeeEngagement.png"
