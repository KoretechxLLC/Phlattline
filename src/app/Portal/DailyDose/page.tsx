...
const DailyDose = () => {
  ...
  const renderEventContent = ({ event, view }: any) => {
    ...
    return (
      <div
        className={`w-full flex flex-col justify-between gap-y-7 h-full px-14 py-5 4xl:py-4 lg:mx-6 4xl:mx-2 5xl:mx-5 rounded-lg text-white border-l-4 ${borderColor} ${futureEvents}`}
        style={{
          backgroundColor,
