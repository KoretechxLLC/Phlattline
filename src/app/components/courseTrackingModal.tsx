...
const CourseTrackingModal = ({
  ...
  if (!open || !courseTrackingData) return null;
  ...
  const handleEnroll = () => {
    ...
    // dispatch(
    //   enrollUserInWorkshop({ userId: userData.id, workshopId: workshop.id })
    // );
  };
      ...
      >
        ...
        <div className="flex-grow flex flex-col">
          ...
          <div className="relative w-full mx-2 mb-2">
            <Image
              src={"/uploads/workShops/thumbnail-1735577721492.png"}
              alt="Workshop Image"
          ...
          <div className="flex items-center justify-between p-4 bg-white rounded-lg mb-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-lg text-gray-500">PHLATINE</p>
              </div>
            </div>
...
export default CourseTrackingModal;
