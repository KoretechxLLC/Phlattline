...
import UploadCVPopup from "./UploadCVPopup";
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-800 leading-7">
                ...
                managed efficiently. This position requires strong organizational
            ...
            <div>
              ...
              <ul className="list-disc pl-6 text-gray-800 leading-7">
                ...
                <li>
                  ...
                  Office Suite (Word, Excel, PowerPoint, Outlook) and familiarity
