...
const JobPopup = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-lg p-8 w-[90%] max-w-4xl overflow-y-auto max-h-[90%]">
        {/* Popup Header */}
        ...
        {/* Job Summary */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-red-600 mb-3">Job Summary:</h3>
          <p className="text-gray-800 leading-7">
            As an Administrative Assistant, you will play a vital role in
            supporting the daily operations of our organization. You will work
            closely with department heads, provide essential support to team
            members, and ensure that all administrative tasks are managed
            efficiently. This position requires strong organizational skills,
        ...
        {/* Qualifications */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-red-600 mb-3">Qualifications:</h3>
          <ul className="list-disc pl-6 text-gray-800 leading-7">
            ...
            <li>
              <strong>Technical Skills:</strong> Proficiency in Microsoft Office
              Suite (Word, Excel, PowerPoint, Outlook) and familiarity with
              scheduling software.
            </li>
            <li>
            ...
            <li>
              <strong>Attention to Detail:</strong> Accuracy and consistency in
              managing data, documentation, and correspondence.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 text-gray-800 leading-7">
            <li>
              ...
              to the management and other team members, including handling phone
              calls, emails, and scheduling appointments.
            </li>
            <li>
            ...
            <li>
              ...
              equipment, ensuring a well-organized, functional work environment.
            </li>
            <li>
              <strong>Communication:</strong> Act as a point of contact for both
              internal and external parties, relaying messages and providing
            ...
            <li>
              <strong>File Management:</strong> Organize and maintain files and
              records, ensuring easy retrieval and security of sensitive
              information.
            </li>
          </ul>
        </div>
