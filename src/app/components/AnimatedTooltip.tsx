        ...
        >
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              ...
              >
                <div className="absolute inset-x-10 z-30 w-[20%] -bottom-px bg-gradient-to-r from-transparent via-gray-600 to-transparent h-px " />
                <div className="absolute left-10 w-[40%] z-30 -bottom-px bg-gradient-to-r from-transparent via-yellow-800 to-transparent h-px " />
