...
import CourseTrackingModal from "./courseTrackingModal";
import EmployeeModal from "./employeeModal";
import { useDispatch, useSelector } from "react-redux";
import { RootState } from "@/redux/store";
import {
  fetchAssignedCoursesCount,
  fetchCoursesAssign,
...
const TaskMonitoring: React.FC = () => {
  ...
  const { coursesAssign,Assignedcoursescount } = useSelector((state: RootState) => state.courses);
  ...
  useEffect(() => {
    if (organization_id) {
      dispatch(fetchAssignedCoursesCount({ organization_id }));
    }
  }, [organization_id, dispatch]);
    ...
    <>
                  ...
                  <div className="grid grid-cols-2 gap-0">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <Button
                        color="primary"
                        size="md"
                        className="rounded-3xl py-4 cursor-pointer"
                      >
                        Assign
                      </Button>
                    </div>
                            ...
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <span
                                  ...
                                  className="ml-3 text-md text-white cursor-pointer"
                                >
                                  {assignee?.first_name +
                                    "  " +
                                    assignee?.last_name}
      ...
      {isModalOpen && (
        <CourseTrackingModal
          ...
          courseTrackingData={selectedCourseData}
        />
      )}
