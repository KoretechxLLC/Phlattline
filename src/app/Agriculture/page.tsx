...
const Agriculture = ({ onModelLoaded }: any) => {
  ...
  const rotateImage1 = useRef<() => void>(null!);
  const rotateImage2 = useRef<() => void>(null!);
  ...
  useEffect(() => {
    ...
    loader.load(
      "/assets/Agricultural.glb", // Path to your construction model
      (gltf) => {
        ...
        addProfileImage(
          new THREE.Vector3(-0.23, 0.35, -1.15),
          "/assets/Hiroshi.png"
        );
        addProfileImage(
          new THREE.Vector3(0.44, 0.25, -1.15),
          "/assets/Alex.png"
        );
        ...
        rotateArrow1.current = addArrow(
          new THREE.Vector3(-0.26, 0.7, 0.12),
          "/assets/ProfileArrow.png"
        );
        rotateArrow2.current = addArrow(
          new THREE.Vector3(0.24, 0.65, 0.88),
          "/assets/ProfileArrow.png"
        );
        rotateArrow3.current = addArrow(
          new THREE.Vector3(1.07, 0.85, 0.14),
          "/assets/ProfileArrow.png"
        );
      ...
      if (earthMeshRef.current) {
        ...
        if (intersects.length > 0) {
          ...
          if (
            ...
            if (
              hoveredObject.userData.name === "Hiroshi Tanaka" ||
              hoveredObject.userData.name === "Alex Johnson"
            ) {
              setHoveredProfile({
