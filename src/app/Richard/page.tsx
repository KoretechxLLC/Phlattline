          ...
          <div className="absolute 3xl:left-[93rem] 4xl:left-[80rem]  flex justify-center items-center inset-0 z-20 left-[108rem] 3xl:gap-10 w-[80rem] gap-12  3xl:w-[21rem]">
            <div className="w-[32rem] 3xl:w-[22rem] 4xl:w-[27rem] relative">
              <div className="flex flex-col leading-none gap-2 4xl:gap-[0.2rem]">
                ...
                <p
                  className="text-white uppercase text-[64px] fullHD:text-[64px] w-[40rem] fullHD:w-[40rem] 3xl:text-[40px] 4xl:text-[48px] 7xl:text-[52px] 8xl:text-[52px] 5xl:text-[52px] font-bold "
                  style={{ fontFamily: "Sansation" }}
                >
                  WHERE I WAS
                </p>
                <p
                  className="text-white uppercase text-[64px] fullHD:text-[64px] 3xl:text-[40px] 4xl:text-[48px] 5xl:text-[52px] 7xl:text-[52px] 8xl:text-[52px] font-bold flex flex-row items-center gap-4 fullHD:gap-4 3xl:gap-2"
                  style={{ fontFamily: "Sansation" }}
                >
                  IN
                  <span
                    className="text-transparent uppercase bg-clip-text 4xl:text-[48px] bg-gradient-to-b from-[#c9b54b] to-[#ffff] text-[64px] fullHD:text-[64px] 3xl:text-[40px] 5xl:text-[52px] 7xl:text-[52px] 8xl:text-[52px] font-bold"
                    style={{ fontFamily: "Sansation" }}
                  >
                    TROUBLE
                  </span>
                  <span className="mt-7 3xl:mt-4 3xl:ml-4 3xl:w-[4rem] 4xl:w-[4rem] ">
                    <img src="./assets/WhitePointer.png" alt="" />
                  </span>
                </p>
              </div>
              <p
            ...
            <div className="flex flex-col w-[20rem] 3xl:w-[12rem] 4xl:w-[13rem] gap-[5rem] absolute 3xl:fixed left-[55rem] 4xl:left-[48rem] 3xl:left-[108rem] 3xl:gap-[3rem]">
              ...
              <img src="./assets/ecosystem.png" alt="" />
            </div>
            ...
            <div className="flex flex-col gap-24">
              <div className="flex items-center 3xl:left-[56rem] 4xl:left-[63rem] gap-12 4xl:gap-1 3xl:gap-8  w-[100rem]">
                <div className="flex flex-col 3xl:w-[22rem] 4xl:w-[27rem] w-[38rem] leading-none">
                  <p
                    className="text-white text-[64px] fullHD:text-[64px] 3xl:text-[40px] 4xl:text-[48px] 5xl:text-[52px] 7xl:text-[52px] 8xl:text-[52px] font-bold"
                    style={{ fontFamily: "Sansation" }}
                  >
                    HOW{" "}
                    <span
                      className="text-transparent bg-clip-text bg-gradient-to-b from-[#c9b54b] to-[#ffff] text-[64px] fullHD:text-[64px] 3xl:text-[40px] 4xl:text-[48px] 5xl:text-[52px] 8xl:text-[52px] 7xl:text-[52px] font-bold"
                      style={{ fontFamily: "Sansation" }}
                    >
                      PHLATTLINE
                    </span>
                ...
                <div className="w-[30rem] 3xl:w-[20rem] 4xl:w-[25rem] 5xl:w-[28rem] 8xl:w-[28rem] 7xl:w-[28rem]">
                  <p
          ...
          <div className="absolute left-[369rem] 3xl:left-[245rem] 4xl:left-[280rem] flex items-center justify-center gap-20 3xl:gap-8 4xl:gap-8">
            <div className="w-[35rem]  3xl:w-[22rem] 4xl:w-[29rem] flex flex-col">
              <div className="flex flex-col leading-none gap-3  3xl:gap-1 4xl:gap-1">
                ...
                <p
                  className="text-white text-[64px] fullHD:text-[64px] 3xl:text-[40px] 5xl:text-[52px] 7xl:text-[52px] 8xl:text-[52px] 4xl:text-[48px] font-bold "
                  style={{ fontFamily: "Sansation" }}
                >
                  I SELECT FROM
                </p>
                <p
                  className="text-transparent bg-clip-text bg-gradient-to-b from-[#c9b54b] to-[#ffff] text-[64px] fullHD:text-[64px] 3xl:text-[40px] 4xl:text-[48px] 5xl:text-[52px] 7xl:text-[52px] 8xl:text-[52px] font-bold"
                  style={{ fontFamily: "Sansation" }}
                >
                  PHLATTLINE
                </p>
